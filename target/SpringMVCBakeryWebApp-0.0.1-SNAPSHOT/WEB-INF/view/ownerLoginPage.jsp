...
<body style=" background: url('https://png.pngtree.com/thumb_back/fh260/background/20230512/pngtree-three-bakers-stand-in-front-of-several-breads-image_2494179.jpg') no-repeat center center fixed;
   ...
   $(document).ready(function () { $('#logoutModal').modal('show'); });
	...
	<div id="main">
		...
		<div id="heading" style="background-color: #C9B194; padding-left: 88px; padding-right: 88px;">
			...
			<h4 style="font-weight: bold; color: #DBDBDB;" >Owner view</h4>
		...
		<div class="card" style="background-color: #C9B194;">
			...
			<form name="loginForm" action="ownerloginController" method="post">
